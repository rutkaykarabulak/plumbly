        ...
        <q-page-container>
            <q-page class="text-center justify-center content-center">
                <div class="contactInformation q-mx-md q-pa-lg shadow-9">
                    ...
                    <p class="text-subtitle1">This will help householders to find you and schedule a service</p>
                    <div class="row items-center justify-center">
                        <div class="col-xs-4">
                            <div class="column content-center">
                                <q-img loading="lazy" alt="Your profile photo" fit="cover" src="@/assets/testImage.png"
                                    style="border-radius: 50%; max-width:100px">
                                    image
                                </q-img>
                                <q-btn class="q-mt-sm" color="dark" rounded size="sm">
                                    Upload photo
                                </q-btn>
                            </div>
                        </div>
                        ...
                        <div class="row items-end q-mt-md">
                            <q-btn to="/signUp/identifyUser" rounded color="dark"
                                class="text-capitalize q-ma-sm">Back</q-btn>
                            <q-btn rounded color="dark" class="text-capitalize q-ma-sm">Next</q-btn>
                        </div>
                    </div>
                </div>
            </q-page>
